	...
	public JMenuBar getMenuBar() {
		...
		ActionListener textureListener = e -> {
				...
				case 3:
					try 
					{
                        currentTexture = textureFromResource("obr/earth.jpg");
                    } 
				...
				case 4:
					try
					{
						currentTexture = textureFromResource("obr/brick.jpg");					
					}
					catch (IOException ex)
					{
						ex.printStackTrace();
				...
				case 5:
					try
					{
						currentTexture = textureFromResource("obr/clouds.jpg");						
					}
					catch (IOException ex)
					{
						ex.printStackTrace();
		...
		makeMenuItem(objectMenu, "Piramidka", objectListener, 7);
