...
public class TransformedShapes extends JPanel {
	...
	/**
	 * Removes any transformations that have been applied to g2, so that it is back
	 * to the standard default coordinate system.
	 */
	...
	/**
	 * Draws a filled circle of radius 50 (diameter 100) centered at (0,0), subject
	...
	/**
	 * Draws a filled square with side 100 centered at (0,0), subject to whatever
	 * transform(s) have been applied to g2.
	 */
	private void square() {
	...
	/**
	 * Draws a filled triangle with vertices at (-50,50), (50,50), and (0,-50),
